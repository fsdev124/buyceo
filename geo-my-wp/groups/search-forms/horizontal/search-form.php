<?php 
/**
 * Group Locator "horizontal" search form template file. 
 * 
 ...
 * your-theme's-or-child-theme's-folder/geo-my-wp/groups/search-forms/
 * 
...
<div class="gmw-form-wrapper gmw-form-wrapper<?php echo $gmw['ID']; ?> gmw-gl-form-wrapper">
