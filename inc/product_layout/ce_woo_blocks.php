...
<div class="rh-container"> 
    <div class="rh-content-wrap clearfix">
        <div id="contents-section-woo-area" class="rh-stickysidebar-wrapper">                      
            <div class="ce_woo_auto ce_woo_auto_sections ce_woo_blocks main-side rh-sticky-container clearfix woo_default_w_sidebar"  id="content">
                        ...
                        <div id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
                            <div class="rh_post_layout_compare_autocontent">
                                ...
                                <div class="title_single_area">
                                    <h1 class="floatleft<?php if(rehub_option('hotmeter_disable') !='1') :?><?php echo getHotIconclass($post->ID); ?><?php endif ;?>"><?php the_title(); ?></h1>
                                    <div class="top_share floatright notextshare ml20">
                                ...
                                <div class="wpsm-two-third tabletblockdisplay wpsm-column-last">
                                    ...
                                    <div class="rh-flex-center-align">
                                        ...
                                        <span class="floatleft font80 mt0">
                                            <?php
